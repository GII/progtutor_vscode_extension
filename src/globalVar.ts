export class GlobalVar {
    ...
    static permisoLibPista2: boolean = false;
    static contErrorConsec1: number = 0;
    static contErrorConsec2: number = 0;
    static umbralCantError = 2;
    static nombreError: string = ''; 
    static modCodigo: boolean = false;
}